...
namespace Mega.Persistance.Migrations
{
    ...
    [Migration("20211013151130_order")]
    partial class order
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mega.Domain.Entities.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mega.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2021, 10, 13, 18, 41, 29, 473, DateTimeKind.Local).AddTicks(2344),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            InsertTime = new DateTime(2021, 10, 13, 18, 41, 29, 478, DateTimeKind.Local).AddTicks(123),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            Id = 3,
                            InsertTime = new DateTime(2021, 10, 13, 18, 41, 29, 478, DateTimeKind.Local).AddTicks(316),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("Mega.Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("Mega.Domain.Entities.Finances.RequestPay", "RequestPay")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Mega.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.HasOne("Mega.Domain.Entities.Orders.Order", "Order")
