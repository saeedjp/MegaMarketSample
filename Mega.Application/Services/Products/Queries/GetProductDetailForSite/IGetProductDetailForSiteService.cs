...
namespace Mega.Application.Services.Products.Queries.GetProductDetailForSite
{
    public interface IGetProductDetailForSiteService
    {
        KhorojiDto<ProductDetailForSiteDto> Execute(long Id);
    }

    public class GetProductDetailForSiteService : IGetProductDetailForSiteService
    {
        private readonly IContext _context;
        public GetProductDetailForSiteService(IContext context)
        {
            _context = context;
        }
        public KhorojiDto<ProductDetailForSiteDto> Execute(long Id)
        {
            ...
            return new KhorojiDto<ProductDetailForSiteDto>()
            {
